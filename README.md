# مالي — Personal Finance App v2

> النسخة الثانية تعيد تصميم لوحة العرض والجوال، وتحفظ البيانات محليًا، وتدعم التنقّل بين الأشهر، والتصنيفات القابلة للإضافة والحذف، والميزانيات المرنة، وتقارير مختصرة، وإشعارات Android، وويدجت واختصار PWA للشاشة الرئيسية.

## التجربة السريعة

- افتح `/demo` لتجربة الواجهة ببيانات واقعية محفوظة تلقائيًا على الجهاز.
- من صفحة **التقرير** اختر **إضافة الاختصار** لتثبيت نسخة PWA دون تنزيل APK.
- نسخة Android 2.0 تطلب إذن الإشعارات من داخل التطبيق وتضيف ويدجت باسم **ملخص مالي**.
